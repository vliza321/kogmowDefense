...
PanelModelClass::PanelModelClass()
{
	m_vertexBuffer = 0;
	m_indexBuffer = 0;
	m_Texture = 0;
...
PanelModelClass::PanelModelClass(const PanelModelClass& other)
{
}
...
bool PanelModelClass::InitializeRender(ID3D11Device* device,  const WCHAR* textureFilename, int instanceCount, XMFLOAT4 PanelRect)
{
	...
	result = LoadModel(modelFilename, PanelRect);
	if (!result)
	{
		return false;
	}
...
void PanelModelClass::Render(ID3D11DeviceContext* deviceContext)
{
...
int PanelModelClass::GetIndexCount()
{
	return m_indexCount;
}

int PanelModelClass::GetInstanceCount()
{
	return m_instanceCount;
}


ID3D11ShaderResourceView* PanelModelClass::GetTexture()
{
	return m_Texture->GetTexture();
}


bool PanelModelClass::InitializeBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void PanelModelClass::ShutdownBuffers()
{
...
void PanelModelClass::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
...
bool PanelModelClass::LoadTexture(ID3D11Device* device, const WCHAR* filename)
{
	bool result;
...
void PanelModelClass::ReleaseTexture()
{
...
bool PanelModelClass::LoadModel(const WCHAR* filename, XMFLOAT4 PanelRect)
{
	ReadFileCounts(filename, PanelRect);

	return true;
}

void PanelModelClass::ReleaseModel()
{
	if (m_model)
	{
		delete[] m_model;
...
bool PanelModelClass::ReadFileCounts(const WCHAR* filename, XMFLOAT4 PanelRect)
{
	ifstream fin;
	char input;
	...
	LoadDataStructures(filename, vertexCount, textureCount, normalCount, faceCount, PanelRect);

	return true;
}

bool PanelModelClass::LoadDataStructures(const WCHAR* filename, int vertexCount, int textureCount, int normalCount, int faceCount, XMFLOAT4 PanelRect)
{
